                  ...
                  <form action="/insertdatapinjam" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="mb-3">
                              ...
                              <input type="tetx" name="judul" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="mb-3">
                              <label for="exampleInputPassword1" class="form-label">ID Buku</label>
                              <input type="number" name="idbuku" class="form-control" id="exampleInputPassword1">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="date" name="Selesai" class="form-control" id="exampleInputPassword1">
                            </div>
